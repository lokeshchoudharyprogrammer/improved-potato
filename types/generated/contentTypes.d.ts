  ...
  attributes: {
    ...
    Class: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    Curriculum_Goal: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::question-builder.question-builder'
    > &
      Schema.Attribute.Private;
  };
}

export interface ApiRcaAssessmentRcaAssessment
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::rca-assessment.rca-assessment'
    > &
      Schema.Attribute.Private;
  };
}

export interface ApiRcaMapRcaMap extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    week: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    rca_assessments: Schema.Attribute.Relation<
      'oneToMany',
      'api::rca-assessment.rca-assessment'
    >;
    createdAt: Schema.Attribute.DateTime;
